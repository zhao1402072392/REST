...
from train_merge_lp import train_merge_lp
...
def main():
    ...
    parser.add_argument('--log_dir', default='/home/sliu/project_space/bias_lottery_pools/static/model_resnet18vw/seed_41/density_0.0005/pre_train_ratio_0.1')
    ...
    parser.add_argument('--decay_value_list', type=float, nargs='+')

    parser.add_argument('--eval_by_ave', default=False, action='store_true')
    ...
    train_merge_lp(model, criterion, data, logger, train_csv_logger, val_csv_logger, test_csv_logger, args, epoch_offset=epoch_offset)
