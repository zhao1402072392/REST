...
from data.confounder_utils import prepare_confounder_data, prepare_confounder_data_cifar10c

# root_dir = 'data/'
root_dir = "/gpfs/scratch1/shared/sliu/overparam/"
dataset_attributes = {
    'cmnist': {
        'root_dir': 'cmnist'
    },
...
def prepare_data(args, train, return_full_dataset=False):
    ...
    if args.dataset == 'cifar10c':
        ...
        for split in ['train', 'valid', 'test']:
            drodataset.append(prepare_confounder_data_cifar10c(args, split, return_full_dataset))
        return drodataset
