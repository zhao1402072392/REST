...
def main():
    ...
    parser.add_argument('--log_dir', default='./logs_sparse_reweight')
    parser.add_argument('--log_every', default=500, type=int)
    parser.add_argument('--save_step', type=int, default=10)
    parser.add_argument('--save_best', action='store_true', default=False)
    parser.add_argument('--save_last', action='store_true', default=False)

    parser.add_argument('--conflict_pct', type=float, default=0.5)
    parser.add_argument('--lambda_upweight', type=float, default=80)
    # ITOP settings
    ...
    test_data = None
    test_loader = None
    if args.shift_type == 'confounder' or args.dataset== 'cifar10c' or args.dataset== 'bffhq' or args.dataset== 'cmnist':
